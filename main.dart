  ...
  return Container(
    ...
    child: ListView(
      ...
      children: <Widget>[
        TextButton(
          onPressed:() async {
            tempList=listProduct;
            listProduct=listProduct.where((x)=>x["category"]=="burger").toList();
             Navigator.push(
                         context,
          ...
          child:
            CategoryListItem(
              ...
              availability: listProduct.where((x)=>x["category"]=="burger").length,
              selected: true,
            ),
        ...
        TextButton(
          onPressed:()async {
            tempList=listProduct;
            listProduct=listProduct.where((x)=>x["category"]=="pizza").toList();
             Navigator.push(
                         context,
                         MaterialPageRoute(builder: (context) => Home2()),
                       )                       
                       .then((value)=>listProduct=tempList);
            await db.collection("products").get().then((event) {
            for (var doc in event.docs) {
              print("\G\O\T\F\I\R\E\B\A\S\E ${doc.id} => ${doc.data()}");
            //  print("\G\O\T\F\I\R\E\B\A\S\E ${listProduct}");
          ...
          child: CategoryListItem(
              ...
              categoryName: "Pizza",
              availability: listProduct.where((x)=>x["category"]=="pizza").length,
              selected: product["category"]=="pizza"? false: true,
          ),
        ),
        ...
        TextButton(
          ...
          onPressed:() async  { 
            tempList=listProduct;
            listProduct=listProduct.where((x)=>x["category"]=="rolls").toList();
             Navigator.push(
                         context,
                         MaterialPageRoute(builder: (context) => Home2()),
                       );
          ...
          child:CategoryListItem(
              ...
              categoryName: "Rolls",
              availability: listProduct.where((x)=>x["category"]=="rolls").length,
              selected:  product["category"]=="rolls"? false: true,
            ),
        ),
      ],
    ),
